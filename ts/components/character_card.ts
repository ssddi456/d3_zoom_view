...
import { character, Character } from '../entities/character';

interface CharactersTabVM {
    characters: KnockoutObservableArray<Character>;
    filterWord: KnockoutObservable<string>;
    clearFilter(): void;
    filtedCharacters: KnockoutComputed<Character[]>;
    addCharacter(): void;
    copyCharacter(character: Character, index: number): void;
...
ko.components.register('characters', {
    viewModel: {
        createViewModel: function (params, componentInfo) {
            const vm: CharactersTabVM = {
                characters: ko.observableArray<Character>([]),
                ...
                filtedCharacters: ko.pureComputed(function () {
                    ...
                    const characters = ko.unwrap<Character[]>(vm.characters);
                ...
                copyCharacter: function (_character: Character, idx: number) {
                ...
                removeCharacter: function (character: Character) {
                    this.characters.remove(character);
                },
                init: function (characters: Character[]) {
            ...
            if (params.characters && params.characters.subscribe) {
                params.characters.subscribe(function (newVal: Character[]) {
                    vm.init(newVal);
                });
            }
